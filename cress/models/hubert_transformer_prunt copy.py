...
class HubertTransformerModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        # replace_linear_layers_with_quantize_recursive(model.encoder.transformer_layers)
        replace_linear_layers_with_quantize_recursive(model.encoder.hubert_model)
