...
@register_model("hubert_transformer_pruning_layer")
...
@register_model_architecture(model_name="hubert_transformer_pruning_layer", arch_name="hubert_transformer_pruning_layer")
...
@register_model_architecture(model_name="hubert_transformer_pruning_layer", arch_name="hubert_transformer_pruning_layer_postln")
