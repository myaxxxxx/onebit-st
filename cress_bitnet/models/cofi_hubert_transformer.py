...
@register_model("cofi_hubert_transformer")
...
@register_model_architecture(model_name="cofi_hubert_transformer", arch_name="cofi_hubert_transformer")
...
@register_model_architecture(model_name="cofi_hubert_transformer", arch_name="cofi_hubert_transformer_postln")
